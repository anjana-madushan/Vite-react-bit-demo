/**
* this env extends react-env version 1.0.34.
* to inspect its config @see https://bit.cloud/teambit/react/react-env?version=1.0.34
* */
...
export class ReactVite extends ReactEnv {
